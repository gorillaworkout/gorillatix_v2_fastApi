...
export default function LoginPage() {
  ...
  // If already authenticated, redirect to profile or the redirect path
  useEffect(() => {
    if (!loading && user) {
  ...
  async function handleGoogleSignIn() {
    ...
    try {
      ...
      toast({
        ...
        description: "Welcome to GorillaTix!",
      })
    ...
    <div className="container flex h-screen  items-center justify-center">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          ...
          <CardDescription>Sign in with your Google account to access your tickets</CardDescription>
        </CardHeader>
